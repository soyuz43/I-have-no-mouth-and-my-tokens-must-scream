...
// ============================================================================
// EXTRACTED STATIC DATA AND PATTERN MODULES
// Behavior preserved: observability.js remains the public behavioral entry point.
// ============================================================================

import {
  OBSERVABILITY_CORE,
  CORE_VERBS_SET,
  EXPANDED_OBSERVABLE_VERBS,
  EXPANDED_VERBS_SET
} from "./observability/verbTables.js";

import {
  PATTERNS
} from "./observability/patterns.js";
